...
const Home = () => {
  ...
  <svg id="about" xmlns="http://www.w3.org/2000/svg" width="100vw" height="60vw" viewBox="0 0 1920 678" fill="none" style={{marginTop:"-30vw"}}>
...
<div className="container" style={{ marginTop: "-50vw", display: 'flex', justifyContent: 'space-around' }}>
  {/* Card 1 */}
...
<section className="cta-section" style={{ marginTop: '40vw', backgroundColor: '#ffffff', color: '#333', padding: '2rem 0', textAlign: 'center', position: 'relative' }}>
...
{/* Footer Section */}
<div style={{ marginTop: '30vw',position: 'relative', zIndex: 1 }}>
<footer className="footer" style={{ zIndex: '0', position: 'absolute', bottom: '0', left: '0', right: '0', backgroundColor: '#f8f9fa', padding: '2rem 0', textAlign: 'center' }}>
  <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
    <div style={{ display: 'flex', alignItems: 'center' }}>
      <img src={logo} alt="Logo" style={{ height: '3vw', marginRight: '10px' }} />
    ...
    <div>
      <a href="https://github.com/mujtabach2" target="_blank" rel="noopener noreferrer" style={{ marginLeft: '0.5rem', color: '#3980d5' }}>
        <img src={githubIcon} alt="GitHub" style={{ height: '2.5vw', marginRight: '5px' }} />
      </a>
      <a href="https://www.linkedin.com/in/mujtaba-chaudhry/" target="_blank" rel="noopener noreferrer" style={{ marginLeft: '0.5rem', color: '#3980d5' }}>
        <img src={linkedinIcon} alt="LinkedIn" style={{ height: '3.5vw', marginRight: '5px' }} />
      </a>
    </div>
  </div>
</footer>
